...
png("C:/Users/Shruti Sankhe/Desktop/Data Analytics/ExData_Plotting1/plot4.png",width=480,height=480)
par(mfrow=c(2,2))
...
plot(x=data1$DateTime,y=data1$Sub_metering_1,xlab="",type="l",ylab="Energy sub metering")
